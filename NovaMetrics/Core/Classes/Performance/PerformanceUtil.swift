...
public class PerformanceUtil {
    public var fpsCallback: ((Int) -> Void)? {
        get { fpsMonitor.callback }
        set { fpsMonitor.callback = newValue }
    }
    ...
    public func cpuUsageForApp() -> Double {
    ...
    public func startFPSMonitor() {
        fpsMonitor.start()
    }

    public func stopFPSMonitor() {
        fpsMonitor.stop()
    }
